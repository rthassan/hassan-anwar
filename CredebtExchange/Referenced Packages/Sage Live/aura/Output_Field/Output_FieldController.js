/**
 * Created by andrew.fenner on 20/09/2016.
 */
({
     doInit:function(component,event,helper){
        var value = helper.getVal(component.get('v.value'),'');
        var type = component.get('v.type');
        var decimalPlaces = helper.getVal(component.get('v.decimalPlaces'), 0);
        var prefix = helper.getVal(component.get('v.prefix'), '');
