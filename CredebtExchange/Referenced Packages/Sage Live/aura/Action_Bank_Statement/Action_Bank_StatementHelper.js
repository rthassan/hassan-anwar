({
   doInit : function (component)
   {
       ...
       //Global action
           ...
           //TODO: Stuff here for global Bank Statement action (if ever..)
       }
   },
   ...
   onAccept : function (component, event)
   {
       ...
       this.callServer(component, 'c.getBankStatementURL', function(response) {
           console.log("c.getBankStatementURL response:" + response);
           var url = response;
